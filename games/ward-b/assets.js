...
function SVG_INTRO() { return `<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg"><defs><radialGradient id="rg" cx="50%" cy="50%" r="60%"><stop offset="0%" stop-color="#1c2230"/><stop offset="100%" stop-color="#030407"/></radialGradient></defs><rect width="1280" height="720" fill="url(#rg)"/><rect x="140" y="100" width="1000" height="480" rx="14" fill="#0f1219" stroke="#3a404f" stroke-width="6"/><circle cx="640" cy="350" r="100" fill="#080a0f" stroke="#6b2828" stroke-width="10"/><text x="640" y="370" text-anchor="middle" fill="#b33a3a" font-size="48" font-family="Georgia,serif" letter-spacing="8">WARD B</text></svg>`; }
function SVG_RECEPTION() { return `<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg"><rect width="1280" height="720" fill="#10131b"/><rect x="0" y="560" width="1280" height="160" fill="#090a0d"/><rect x="120" y="310" width="1040" height="210" rx="10" fill="#231e1c" stroke="#4a3c34" stroke-width="5"/><rect x="760" y="140" width="230" height="140" fill="#040508" stroke="#40475a" stroke-width="8"/><text x="165" y="260" fill="#505a6a" font-size="52" font-family="Georgia,serif">RECEPTION</text></svg>`; }
function SVG_CORRIDOR() { return `<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg"><rect width="1280" height="720" fill="#0b0d14"/><path d="M170 70h940L930 670H350z" fill="#14182a" stroke="#383c4e" stroke-width="6"/><path d="M505 110h270l35 540H470z" fill="#060709"/><circle cx="640" cy="185" r="42" fill="#b88040" opacity=".5" class="glow"/></svg>`; }
function SVG_RECORDS() { return `<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg"><rect width="1280" height="720" fill="#111420"/><g stroke="#424a5c" stroke-width="6" fill="#1e2230"><rect x="125" y="175" width="265" height="365"/><rect x="440" y="135" width="255" height="415"/><rect x="745" y="185" width="335" height="355"/></g><circle cx="320" cy="560" r="58" fill="#d4b86a" opacity=".3"/></svg>`; }
function SVG_PHARMACY() { return `<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg"><rect width="1280" height="720" fill="#10131a"/><rect x="145" y="110" width="990" height="460" fill="#181d2b" stroke="#464e64" stroke-width="7"/><g fill="#080b10" stroke="#2e3545" stroke-width="4"><rect x="205" y="165" width="195" height="315"/><rect x="430" y="165" width="195" height="315"/><rect x="655" y="165" width="195" height="315"/><rect x="880" y="165" width="195" height="315"/></g><rect x="548" y="335" width="98" height="52" rx="10" fill="#d4c08a" stroke="#6b5a30" stroke-width="4"/></svg>`; }
function SVG_SURGERY() { return `<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg"><rect width="1280" height="720" fill="#0b0c11"/><ellipse cx="640" cy="580" rx="440" ry="95" fill="#060709"/><rect x="350" y="410" width="580" height="72" rx="22" fill="#1e2430" stroke="#5e6578" stroke-width="6"/><circle cx="640" cy="165" r="92" fill="#d8c07a" opacity=".22" class="glow"/><path d="M640 0v165" stroke="#3a404e" stroke-width="8"/></svg>`; }
function SVG_SURGERY_SEDATED() { return `<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg"><rect width="1280" height="720" fill="#080a0e"/><ellipse cx="640" cy="580" rx="440" ry="95" fill="#040507"/><rect x="350" y="410" width="580" height="72" rx="22" fill="#1a1e2a" stroke="#4a5060" stroke-width="6"/><circle cx="640" cy="165" r="92" fill="#7ab0d8" opacity=".10"/><circle cx="920" cy="340" r="12" fill="#40c060" opacity=".9"/></svg>`; }
function SVG_OBSERVATION() { return `<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg"><rect width="1280" height="720" fill="#09090e"/><g fill="#0d0e14" stroke="#2a2d3a" stroke-width="4"><rect x="100" y="160" width="220" height="340"/><rect x="360" y="160" width="220" height="340"/><rect x="620" y="160" width="220" height="340"/><rect x="880" y="160" width="220" height="340"/></g><path d="M0 530h1280" stroke="#1a1d28" stroke-width="3"/></svg>`; }
function SVG_COURTYARD() { return `<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg"><rect width="1280" height="720" fill="#060809"/><rect y="520" width="1280" height="200" fill="#0f1510"/><path d="M115 105h1050l-65 420H180z" fill="#13171e" stroke="#363f52" stroke-width="7"/><circle cx="640" cy="340" r="40" fill="#581a1a"/></svg>`; }
function SVG_ESCAPE_GATE() { return `<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg"><rect width="1280" height="720" fill="#070809"/><g stroke="#5a6070" stroke-width="12" fill="none"><line x1="420" y1="80" x2="420" y2="660"/><line x1="530" y1="80" x2="530" y2="660"/><line x1="640" y1="80" x2="640" y2="660"/><line x1="750" y1="80" x2="750" y2="660"/><line x1="860" y1="80" x2="860" y2="660"/></g><rect x="350" y="320" width="580" height="80" rx="10" fill="#2a1a1a" stroke="#8a3030" stroke-width="6"/></svg>`; }
...
function SVG_OUTSIDE() { return `<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg"><rect width="1280" height="720" fill="#080c10"/><rect y="480" width="1280" height="240" fill="#0c1008"/><circle cx="640" cy="200" r="80" fill="#c8d8f0" opacity=".12"/><path d="M0 480 Q320 460 640 470 Q960 480 1280 465" fill="none" stroke="#1a2018" stroke-width="8"/></svg>`; }
function SVG_STAIRWELL() { return `<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg"><rect width="1280" height="720" fill="#090b10"/><path d="M185 95h910v530H185z" fill="#13161e" stroke="#363c4e" stroke-width="7"/><path d="M325 610h630v-80H405v-86h462v-80H490v-86h302v-80H572" fill="none" stroke="#484e62" stroke-width="30"/><g fill="#7a2525" opacity=".6"><circle cx="385" cy="210" r="18"/><circle cx="495" cy="298" r="15"/><circle cx="580" cy="386" r="22"/></g></svg>`; }
function SVG_BASEMENT() { return `<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg"><rect width="1280" height="720" fill="#060708"/><rect y="460" width="1280" height="260" fill="#080c0a" opacity=".9"/><rect x="100" y="100" width="1080" height="580" rx="8" fill="none" stroke="#1a2020" stroke-width="6"/><circle cx="200" cy="180" r="30" fill="#8a1a1a" opacity=".7"/><rect x="900" y="200" width="180" height="320" rx="4" fill="#0d1010" stroke="#2a3030" stroke-width="4"/></svg>`; }
function SVG_DEATH_BASEMENT() { return `<svg viewBox="0 0 1280 720" xmlns="http://www.w3.org/2000/svg"><rect width="1280" height="720" fill="#030405"/><rect y="400" width="1280" height="320" fill="#040808"/><circle cx="640" cy="360" r="200" fill="#0a0505" stroke="#3a0808" stroke-width="6" opacity=".8"/><text x="640" y="380" text-anchor="middle" fill="#6a1010" font-size="52" font-family="Georgia,serif" letter-spacing="4">THE DARK</text></svg>`; }
